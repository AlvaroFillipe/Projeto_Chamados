...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/admin" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Easy Life</span>
      </a>
    ...
    <nav class="header-nav ms-auto">
      ...
      <form action="Show_configs" method="post">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Funções de usuario</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/show_historico_geral">
              <i class="bi bi-circle"></i><span>Historico</span>
            </a>
          </li>         
        </ul>
      </li><!-- End Tables Nav -->
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Alvaro Filipe</span></strong>
    </div>
